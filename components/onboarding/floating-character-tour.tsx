...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: "Main Navigation Rail",
    description: "Switch seamlessly between your Masterclass Projects, Architecture Templates, API Documentation, and Settings.",
    tip: "Clean icon-driven navigation with compact liquid glass styling.",
    mascotMood: "waving",
    speech: "Hey! I'm Leo, your creator guide. Follow my curly arrow to discover your dashboard!",
    arrowLabel: "Sidebar Rail",
    preferredPlacement: "right",
  },
  {
    id: 2,
    selector: '[data-tour="search-bar"]',
    title: "Instant Masterclass Search",
    ...
    mascotMood: "pointing",
    speech: "Looking for an existing graph? Follow the arrow and type right here!",
  ...
  },
  {
    ...
    mascotMood: "pointing",
    speech: "This is where the magic happens! Click here to dump your notes or PDFs.",
  ...
  },
  {
    ...
    title: "Previous Masterclasses Grid",
    description: "Each session card displays thumbnail previews, node count, source badges, and last edited time. Click any card to enter the full Railway canvas.",
    tip: "Inside the canvas you get Dagre auto-layout, mini-map, and SVG/Markdown export.",
    mascotMood: "thinking",
    speech: "Look at all your mind maps! Click any card to open the interactive canvas with auto-layout.",
    arrowLabel: "Masterclasses",
    preferredPlacement: "top",
  },
  {
    id: 5,
    selector: '[data-tour="sidebar-tour"]',
    title: "Summon Leo Anytime",
    description: "Need a refresher or want to run the full interactive extraction simulation? Click this widget anytime to launch the guided tour.",
    tip: "You can also explore /onboarding for a complete standalone tour experience.",
    mascotMood: "celebrating",
    speech: "You're all set to build amazing visual masterclasses! I'm always here if you need help.",
    arrowLabel: "Summon Guide",
    preferredPlacement: "right",
  },
];
