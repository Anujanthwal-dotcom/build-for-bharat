  ...
  return (
    <div className="flex-1 overflow-y-auto p-8">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        {/* Danger Zone */}
        <section className="border border-red-500/20 rounded-lg overflow-hidden">
          <div className="bg-red-500/5 px-6 py-4 border-b border-red-500/10">
            <h2 className="text-sm font-mono uppercase tracking-wider text-red-400">Danger Zone</h2>
          </div>
          <div className="p-6">
